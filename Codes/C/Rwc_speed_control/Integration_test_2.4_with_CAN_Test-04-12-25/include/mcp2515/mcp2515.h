...
class MCP2515 {
    ...
    public:
        MCP2515(
            ...
            uint8_t CS_PIN = 9,                        //PICO_DEFAULT_SPI_CSN_PIN,
            uint8_t TX_PIN = 4,                        //PICO_DEFAULT_SPI_TX_PIN,
            uint8_t RX_PIN = 3,                        //PICO_DEFAULT_SPI_RX_PIN,
            uint8_t SCK_PIN = 2,                       //PICO_DEFAULT_SPI_SCK_PIN,
